...
//the trim method removes extra whitespace (spaces) from both ends in a string
...
let threat = 'My number ' + num + "'s named " + '"' + first + " " + last + `": and you don't ` + phrase + "!"
console.log(threat)
...
let newThreat = `My number ${num}'s named "${first} ${last}": and you don't ${phrase}!`
console.log(newThreat)
