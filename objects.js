...
// 1.1
//  Create an object literal (let obj = {} ) that has 5 properties.
//  Each one of these properties should contain a
//  different types of PRIMITIVE (string, num, boolean, null, undef.....not arrays/objects) values. (Primitive
...
let donaldName = person2['name'] //has to be a string of what the key is called
...
let {name, age: years} = person4  //can change the name of variable
...
console.log(person5.possessionCategories[1].list[1].model)

let model = person5.possessionCategories[1].list[1].model

// 2.5b
//  person5's second-listed sibling,

let secondSibling = person5.siblings[1]
console.log(secondSibling)
//console.log each piece until you find what you need
